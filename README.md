# [x-ui](https://github.com/amclubs/x-ui)
x-ui面板,支持多协议多用户的 xray 面板
...
```
bash <(curl -Ls https://raw.githubusercontent.com/amclubs/x-ui/main/install.sh)

```

## 手动安装&升级

1. 首先从 https://github.com/amclubs/x-ui/releases 下载最新的压缩包，一般选择 `amd64`架构
